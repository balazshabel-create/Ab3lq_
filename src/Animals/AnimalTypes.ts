...
export const ANIMALS: Record<Species, AnimalDef> = {
  ...
  [Species.Capybara]: {
    ...
    silhouette: {
      ...
      height: 0.6,
      width: 0.48,
      colors: { body: 0x84492a, belly: 0x6a3a21, accent: 0x53301b, eye: 0x120c08 },
  ...
  [Species.Crocodile]: {
    ...
    silhouette: {
      ...
      height: 0.5,
      width: 0.78,
      colors: { body: 0x6b6d4c, belly: 0xa7a07b, accent: 0x3d4130, eye: 0xc9a227 },
  ...
  [Species.Turtle]: {
    ...
    silhouette: {
      ...
      height: 0.28,
      width: 0.44,
      colors: { body: 0xa9873d, belly: 0xd8c78f, accent: 0x8b6b2c, eye: 0x100c08 },
      bodyPlan: BodyPlan.Shelled,
      legPairs: 2,
      tail: 0.08,
    },
  ...
  [Species.Tiger]: {
    ...
    silhouette: {
      ...
      height: 0.95,
      width: 0.62,
      colors: { body: 0xc7742a, belly: 0xf5efe3, accent: 0x17110c, eye: 0xd8c95c },
      bodyPlan: BodyPlan.Feline,
      legPairs: 2,
      tail: 0.62,
    },
  ...
  [Species.Gorilla]: {
    ...
    silhouette: {
      ...
      // Lifted well off true black, twice now. A gorilla is black, but a black
          ...
          colors: { body: 0x2b2729, belly: 0x393337, accent: 0xb9b4ad, eye: 0x3a2a18 },
      bodyPlan: BodyPlan.Primate,
      legPairs: 2,
      tail: 0,
    },
